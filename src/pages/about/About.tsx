        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap justify-center -m-4">
            {teamData.map((member, index) => (
              <div key={index} className="p-4 pt-10 md:w-1/3 sm:w-1/2 w-full flex flex-col text-center items-center">
                <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative">
                  <div className="flex flex-col items-center pb-10">
                    ...
                    <div className="flex mt-4 md:mt-6">
                      <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-lime-500 rounded-lg hover:bg-lime-600 focus:ring-4 focus:outline-none focus:ring-lime-300 dark:bg-lime-500 dark:hover:bg-lime-600 dark:focus:ring-lime-600">Add friend</a>
                      <a href="#" className="py-2 px-4 ms-2 text-sm font-medium text-lime-500 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-lime-500 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-lime-500 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Message</a>
                    </div>
                  </div>
                </div>
              </div>
